...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { marca_active: @marca.marca_active, marca_descrip: @marca.marca_descrip } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { marca_active: @marca.marca_active, marca_descrip: @marca.marca_descrip } }
