...
class SucursalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sucursale" do
    assert_difference('Sucursale.count') do
      post sucursales_url, params: { sucursale: { suc_activo: @sucursale.suc_activo, suc_descrip: @sucursale.suc_descrip } }
    end
  ...
  test "should update sucursale" do
    patch sucursale_url(@sucursale), params: { sucursale: { suc_activo: @sucursale.suc_activo, suc_descrip: @sucursale.suc_descrip } }
