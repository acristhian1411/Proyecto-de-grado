...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post ciudades_url, params: { ciudade: { activo: @ciudade.activo, descripcion: @ciudade.descripcion } }
    end
  ...
  test "should update ciudade" do
    patch ciudade_url(@ciudade), params: { ciudade: { activo: @ciudade.activo, descripcion: @ciudade.descripcion } }
